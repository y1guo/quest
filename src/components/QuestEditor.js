...
export default function QuestEditor(props) {
  ...
  useEffect(() => {
    const unsubscribe = listenToUserData(setLogs, "active", props.id, "logs");
    return unsubscribe;
  }, [props.id]);
        ...
        >
          ...
          <Box sx={{ overflow: "auto" }}>
            ...
            <Grid container py={2} px={2} spacing={2} alignItems="center">
              ...
              <Grid item xs={6} sm={3} md={2}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value={"none"}>{questTypeNames["none"]}</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
              <Grid item xs={6} sm={3} md={2}>
              ...
              <Grid item xs={6} sm={3} md={2}>
                <FormControl fullWidth>
                  <InputLabel>{questFieldNames["prerequisite"]}</InputLabel>
                  <Select native defaultValue="" label="Grouping">
                    <option value="" />
